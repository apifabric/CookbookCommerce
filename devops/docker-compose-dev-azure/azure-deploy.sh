...
resourcename="culinaryconnect"  # lower case, only
resourcegroup="culinaryconnect_rg"
...
# git clone https://github.com/apilogicserver/culinaryconnect.git
# cd culinaryconnect
...
az group create --name culinaryconnect_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group culinaryconnect_rg --sku S1 --is-linux
az container create --resource-group culinaryconnect_rg --name culinaryconnect --image apilogicserver/culinaryconnect:latest --dns-name-label culinaryconnect --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//culinaryconnect.westus.azurecontainer.io:5656'
